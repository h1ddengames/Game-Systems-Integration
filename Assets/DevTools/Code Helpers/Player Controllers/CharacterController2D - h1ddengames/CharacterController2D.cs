...
namespace h1ddengames {
    public class CharacterController2D : MonoBehaviour {
        ...
        [BoxGroup("Events"), InfoBox("This event will run on every frame that isGrounded is true", EInfoBoxType.Normal), SerializeField] private UnityEvent isOnGroundEvent;
        [BoxGroup("Events"), InfoBox("Can accidentally be called if there's an overlap between two colliders", EInfoBoxType.Warning), InfoBox("This event will run on every frame that isGrounded is false", EInfoBoxType.Normal), SerializeField] private UnityEvent isNotOnGroundEvent;
        [BoxGroup("Events"), InfoBox("This event will run on every frame that moveInput is not 0", EInfoBoxType.Normal), SerializeField] private UnityEvent isMovingEvent;
        #endregion
